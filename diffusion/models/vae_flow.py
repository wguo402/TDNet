...
class FlowVAE(Module):
    ...
    def get_loss(self, x, kl_weight, writer=None, it=None):
        ...
        z = reparameterize_gaussian(mean=z_mu, logvar=z_sigma)  # (B, F)mean is the mean of the Gaussian distribution, and logvar is the variance of the Gaussian distribution
