...
class NaiveRpnHead(nn.Module):
    ...
    def forward(self, x):
        ...
        pred_confidence=x.view(x.size(0),-1)#
        return pred_cls, pred_loc,pred_z_axis,pred_confidence
...
class RPN(nn.Module):
    ...
    def forward(self, x):
        ...
        rpn_pred_cls, rpn_pred_loc,pred_z_axis,pred_confidence = self.rpn_head(out)
        return rpn_pred_cls, rpn_pred_loc,pred_z_axis,pred_confidence