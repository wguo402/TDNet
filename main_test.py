...
parser.add_argument('--which_dataset', type=str, default='KITTI', help='datasets: KITTI,NUSCENES,WAYMO')
...
parser.add_argument('--n_gpus', type=int, default=1, help='# GPUs')
...
parser.add_argument('--visual', type=bool, default=True, help='save data for visualization')
# parse arguments
...
def init_opts(opts, manual_opts):
    ...
    opts.data_save_path = os.path.join('',
    ...
    opts.model_path = "%s/netR_30.pth" % (opts.results_dir)
