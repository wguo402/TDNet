...
opts.n_input_feats1 = 0
opts.use_xyz = True

# attention
opts.feat_emb = 32
opts.iters = 2
opts.knn_num =48 #24 #96
...
opts.db = AttrDict(
    KITTI = AttrDict(
        data_dir = "/home/lqg/lzj/dataset/3D_dataset/kittle_tracking/training/",
        val_data_dir = "/home/lqg/lzj/dataset/3D_dataset/kittle_tracking/training/",
        category_name = ["Car", "Pedestrian", "Van", "Cyclist"][0],
    ),
    NUSCENES = AttrDict(
        data_dir = "/home/lqg/lzj/dataset/3D_dataset/nusc_kitti/train_track/",
        val_data_dir = "/home/lqg/lzj/dataset/3D_dataset/nusc_kitti/train_track/",
        category_name = ["car", "pedestrian", "truck", "bicycle"][0],
    ),
    WAYMO = AttrDict(
        data_dir = "/home/lqg/lzj/dataset/3D_dataset/archived_files/validation_2/",
        val_data_dir = "/home/lqg/lzj/dataset/3D_dataset/archived_files/validation_2/",
